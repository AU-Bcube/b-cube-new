                        ...
                        <div className="mb-6 rounded-xl bg-[#111827] p-6">
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                <label className="flex items-center gap-3 md:col-span-2">
                                    ...
                                    >
                                        <span
                                            className={`absolute top-0.5 left-0.5 h-6 w-6 rounded-full bg-white transition-transform ${recruitSettings.isRecruiting ? "translate-x-5" : ""}`}/>
                                    </button>
                    ...
                    {recruitSettings.isRecruiting ? "모집 중" : "모집 마감"}
                                ...
                                <label className="flex flex-col gap-1.5 md:col-span-2">
                                    ...
                                    <textarea
                                        ...
                                        onChange={(e) => setRecruitSettings((s) => ({
                                            ...s,
